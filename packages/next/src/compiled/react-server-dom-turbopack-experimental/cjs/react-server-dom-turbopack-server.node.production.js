...
function decodeReplyFromBusboy(busboyStream, turbopackMap, options) {
  const response = createResponse(turbopackMap, '', options ? options.temporaryReferences : undefined, undefined, options ? options.arraySizeLimit : undefined);
  let pendingFiles = 0;
  const queuedFields = [];
...
function decodeReply(body, turbopackMap, options) {
  ...
  const response = createResponse(turbopackMap, '', options ? options.temporaryReferences : undefined, body, options ? options.arraySizeLimit : undefined);
